...
type MatrixQuadrant = "Act Now" | "Margin Recovery" | "Watchlist" | "Stable";
const MATRIX_QUADRANTS: { key: MatrixQuadrant; cls: string }[] = [
  { key: "Act Now", cls: "matrix-act-now" },
  { key: "Margin Recovery", cls: "matrix-margin-recovery" },
